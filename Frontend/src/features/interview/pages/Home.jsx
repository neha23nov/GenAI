...
const Home = () => {
  ...
  const handleGenerateReport = async () => {
    ...
    if (!resumeFile && !selfDescription.trim()) return alert('Upload a resume or add a self-description')
                            ...
                            <label className='dropzone' htmlFor='resume'>
                                ...
                                {resumeFileName ? (
                                    <>
                                        ...
                                        <p className='dropzone__subtitle'>Click to choose a different file</p>
                                    </>
                                ) : (
                                    <>
